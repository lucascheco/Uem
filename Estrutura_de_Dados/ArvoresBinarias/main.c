/***********************************************************************************
    ...
    Description: Árvores Binárias, aplicação.
    Date:        25/03/2021
************************************************************************************/
...
{   
    ...
    printf("7  - Em-Ordem\n");
    printf("8  - Pos-Ordem\n");
    printf("9  - Consulta Pai\n");
    printf("10 - Consulta Ascendente\n");
    printf("11 - Mostra ABB\n");
    printf("12 - Sair\n");
    printf("> ");
    ...
    switch (op)
    {
        ...
        case 10:
            ...
            else
            {
                ...
                if (!consultaAscendente(arvore, &dado, nivel))
                    printf("Registro Nao encontrado!\n");
                else
                    printa_dado(dado, 1);
